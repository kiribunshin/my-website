...
* **Icons/Assets:** Original/public domain assets in `/pictures`

### 📝 Note
I built this because I wanted a space on the web that I actually own. It’s a work in progress, so things might shift around as I experiment with new designs. 
Feel free to use the code as inspiration for your own project.
